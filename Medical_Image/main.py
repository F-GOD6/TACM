...
import torch
import os
from data_generator import DermNet, ISIC
from maml import MAML
from copy import deepcopy
from torch.distributions import Beta
parser = argparse.ArgumentParser(description='MLQA')
parser.add_argument('--datasource', default='isic', type=str,
                    help='dermnet or isic')
...
parser.add_argument('--logdir', default='/home/fanjiangdong/workspace/MLQA-main/Medical_Image/logdict', type=str,
...
def main():
    ...
    if args.train == 1:
        ...
        # # model_file = '{0}/{2}/model{1}'.format(args.logdir, args.test_epoch, exp_string)
        # model_file = "/home/fanjiangdong/Github/MLQA-main/Miniimagenet/logdict/MLQA.data_miniimagenet.cls_5.mbs_4.ubs_1.metalr_0.001.innerlr_0.01.hidden32.mix.aug/model11500"
        # maml.load_state_dict(torch.load(model_file))
        # test(args, maml, args.test_epoch)

        model_dir = "/home/fanjiangdong/Github/MLQA-main/Miniimagenet/logdict/MLQA.data_miniimagenet.cls_5.mbs_4.ubs_5.metalr_0.001.innerlr_0.01.hidden32.mix.aug"
